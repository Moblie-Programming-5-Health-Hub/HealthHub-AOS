...
class LocalData(context: Context) {
    ...
    var male: String
        set(value) = dataStore.edit { putString(MALE, value) }
        get() = dataStore.getString(MALE, "") ?: ""

    var female: String
        set(value) = dataStore.edit { putString(FEMALE, value) }
        get() = dataStore.getString(FEMALE, "") ?: ""
